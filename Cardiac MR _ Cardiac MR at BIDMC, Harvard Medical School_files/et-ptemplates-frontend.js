...
/*
     FILE ARCHIVED ON 22:23:08 Feb 6, 2015 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 3:38:00 Mar 15, 2017.
...
jQuery(document).ready(function() {
	...
	jQuery("a[class*='et_video_lightbox']").click(function(){
		...
		if ( et_vimeo != null )	et_video_link = '/web/20150206222308/http://player.vimeo.com/video/' + et_vimeo[1];
		else {
			et_youtube = et_video_href.match(/watch\?v=([^&]*)/i);
			if ( et_youtube != null ) et_video_link = '/web/20150206222308/http://youtube.com/embed/' + et_youtube[1];
		}
